  ...
  return (
    ...
    >
      ...
      <ShortAnswer
        ...
        minLength={8} onChange={handleChange} onBlur={handleBlur}
        value={formData.password || ""} required
      />
      {errors.password && <p className="text-red-500 text-sm -mt-2">{errors.password}</p>}

      <ShortAnswer
        type="password" name="re_password" label="Confirm Password*"
        minLength={8} onChange={handleChange} onBlur={handleBlur}
        value={formData.re_password || ""} required
      />
      ...
      <ShortAnswer
        type="number" name="first_comp" label="First Competition Year*"
        min="1900" max="9999" onChange={handleChange} onBlur={handleBlur}
        value={formData.first_comp || ""} required
      />
      {errors.first_comp && <p className="text-red-500 text-sm -mt-2">{errors.first_comp}</p>}

      <DatePicker
        label="Graduation Date*" name="grad_date"
        onChange={handleChange} onBlur={handleBlur}
        value={formData.grad_date || ""} required
      />
      {errors.grad_date && <p className="text-red-500 text-sm -mt-2">{errors.grad_date}</p>}

      <Dropdown
        options={skillLevels} label="Experience Level*" name="skill_level"
        onChange={handleChange} onBlur={handleBlur}
        value={formData.skill_level || ""} required
      />
      {errors.skill_level && <p className="text-red-500 text-sm -mt-2">{errors.skill_level}</p>}

      <Dropdown
        options={colleges} label="College*" name="school"
        onChange={handleChange} onBlur={handleBlur}
        value={formData.school || ""} required
      />
      {errors.school && <p className="text-red-500 text-sm -mt-2">{errors.school}</p>}

      <Dropdown
        options={genderChoices} label="Gender*" name="gender"
        onChange={handleChange} onBlur={handleBlur}
      ...
      <Dropdown
        options={studentTypes} label="Student Type*" name="student_type"
        onChange={handleChange} onBlur={handleBlur}
        value={formData.student_type || ""} required
      />
