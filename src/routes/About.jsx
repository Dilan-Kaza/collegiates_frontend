    ...
    <>
      ...
      <div className="flex-col bg-primary text-off-white md:py-10">
        <div className="content-center w-full max-w-8/10 translate-x-1/10">
          <div>&nbsp;</div>
          <header className="flex items-center text-2xl md:text-6xl animate-fadeIn">ABOUT</header>
          <div>&nbsp;</div>
          <div className="text-lg md:text-2xl">Wushu</div>
          <div>&nbsp;</div>
          <div className="text-sm md:text-base">The term <a className="font-bold">Wushu</a> encompasses all of Chinese martial arts, which is composed of an enormous range of martial styles and philosophies.
          ...
          <div>&nbsp;</div>
          <div className="text-lg md:text-2xl">Collegiate Wushu</div>
          <div>&nbsp;</div>
          <div className="text-sm md:text-base">The Annual Collegiate Wushu Tournament was created to foster collegiate-level wushu in the nation. The first tournament was hosted by the University of Oregon in 1997, organized by Brandon Sugiyama. Today, the tournament draws in competitors from universities all across the country and has been hosted on both the east and west coasts.</div>
          <div>&nbsp;</div>
          <div className="text-lg md:text-2xl">Collegiate Wushu</div>
          <div>&nbsp;</div>
          <div className="translate-x-4 text-sm md:text-base"><a href="http://jiayoowushu.com/collegiate-wushu-usa/" className="hover:underline text-secondary">Collegiate Wushu in the United States: What it Means for US Wushu</a> by Matthew Lee<br/>
      ...
      <div className="flex-col  bg-off-white text-primary md:py-10">
        <div className="content-center w-full max-w-8/10 translate-x-1/10">
          <div>&nbsp;</div>
          <header className="flex items-center text-2xl md:text-6xl animate-fadeIn">CWCMembers</header>
          <div>&nbsp;</div>
          <div className="text-sm md:text-base">The Collegiate Wushu Committee (CWC) currently consists of one voting representative from each of the following universities:</div>
          <div>&nbsp;</div>
          <div className="translate-x-4 text-sm md:text-base">
          ...
          <div>&nbsp;</div>
          <div className="text-sm md:text-base">The CWC also includes alumni members serving as advisers.<br/>
            <br/>
            Each year, a call is made to clubs for the position of host, and bids are voted on by the 
            Collegiate Wushu Committee voting members. The CWC is composed of advisers and school representatives, 
            with each school on the CWC posessing one voting representative. The CWC also discusses and votes on changes to 
            tournament rules such as competitor eligiblity requirements and experience level determination. Once a school has 
            hosted a Collegiate Wushu Tournament, they will receive an invitation to join the CWC.
            <br/>
            <br/>
          </div>
        </div>
      ...
      <div className="flex-col  bg-primary text-off-white md:py-10">
        <div className="content-center w-full max-w-8/10 translate-x-1/10">
          <div>&nbsp;</div>
          <header className="flex items-center text-2xl md:text-6xl animate-fadeIn">Previous Hosts</header>
          <div>&nbsp;</div>
          <div className="max-h-100 overflow-y-auto text-sm md:base">
